...
due to a given mask. Both the brain slice image and the mask need to have the same
size. The optional argument -r resizes both images according a specified width.

Example: python AIDAhisto_maskSize.py "path/to/brainSliceImage" "path/to/brainMaskImage" -r 3000
...
def main(path1, path2):
    ...
    if imgB.size != imgM.size:
        print("Error: Dimension of input image and mask do not agree")
    else:
        if args.newSize != 0:
