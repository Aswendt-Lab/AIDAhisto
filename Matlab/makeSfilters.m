function F=makeSfilters(size)
% Returns the S filter bank. To convolve an image I with the filter 
% bank you can either use the matlab function
% modified version of code provided at
% http://www.robots.ox.ac.uk/~vgg/research/texclass/filters.html
% see this website for details.

  NF=13;                        % Number of filters
  SUP=size;                       % Support of largest filter (must be odd)
  F=zeros(SUP,SUP,NF);
